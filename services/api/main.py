...
from app.runtime import dashboard, files, health, metrics, shows, upload  # noqa: E402
...
app = FastAPI(
    title="Docs to Podcast API",
    description="Turn documents into a 2-host AI podcast, archived on Backblaze B2",
    version="0.1.0",
    lifespan=lifespan,
)
