...
const navItems = [
  ...
  { title: "Shows", href: "/shows", icon: Library },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-docs-to-podcast"
          target="_blank"
